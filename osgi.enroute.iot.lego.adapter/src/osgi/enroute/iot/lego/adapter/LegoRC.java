...
enum Channel {
	CH1(0b0000_0000_0000_0000),
	CH2(0b0001_0000_0000_0000),
	CH3(0b0010_0000_0000_0000),
	CH4(0b0011_0000_0000_0000);
...
public class LegoRC extends ICAdapter<LegoPowerFunctions, Wave> implements LegoPowerFunctions {
	...
	final int			START_STOP				= 1184 - 158;			// 6 +
																		// 39 =
																		// 45 x
																		// 1/38K
																		// =
																		// 1184
																		// us/
	final int			LOW						= 421 - 158;			// 6 +
																		// 10 =
																		// 16 x
																		// 1/38K
																		// = 421
																		// us
	final int			HIGH					= 711 - 158;			// 6 +
																		// 21 =
																		// 27 x
																		// 1/38K
																		// = 711
	...
	void activate(Map<String, Object> map) throws Exception {
		LegoPowerFunctionsConfig config = Converter.cnv(LegoPowerFunctionsConfig.class, map);
