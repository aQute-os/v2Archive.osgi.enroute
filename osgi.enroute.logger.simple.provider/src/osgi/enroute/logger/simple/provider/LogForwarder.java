...
public class LogForwarder implements ILoggerFactory {
	...
	private static final Bundle							thisBundle				= FrameworkUtil
		.getBundle(LogForwarder.class);
	private static final SecurityManagerContext			securityManagerContext	= new SecurityManagerContext();
	private final BlockingQueue<Runnable>				queue					= new LinkedBlockingQueue<>(
		QUEUE_CAPACITY);
	private static LogForwarder							SINGLETON				= new LogForwarder();
	private final ReferenceQueue<Facade>				referenceQueue			= new ReferenceQueue<>();

	// Guardby lock
	private Object										lock					= new Object();
	private final IdentityHashMap<LogService, Integer>	rankedLogServices		= new IdentityHashMap<>();
	private final Map<LoggerId, FacadeReference>		facades					= new HashMap<>();
	private LogService									selectedLogService		= null;
