...
// @formatter: off
@Info(title = "Example Open API annotations", description = "Shows all the Open API annotations in place", version = "3.0.0.draft")
public class OpenAPIExample implements REST {
	...
	public String getResponse_ok() throws FileNotFoundException, IllegalArgumentException {
		return "";
	}
}
