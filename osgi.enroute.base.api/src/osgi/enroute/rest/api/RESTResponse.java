...
public class RESTResponse extends Exception {
	 ...
	 * @param value the value
	 */
	public RESTResponse(String message, int statusCode, Object value, String contentType, Throwable cause) {
	 ...
	 * @param value the value
	 */
	public RESTResponse(String message, int statusCode, Object value, String contentType) {
	...
	public static class Redirect extends RESTResponse {
		...
		/**
		 * @param code the redirect code (in the 3xx range)
