...
public interface DTOs {
	...
	interface Converter {
		 ...
		 *
		 * @param dest the destination type specification
	 ...
	 *
	 * @param source The source to convert, {@code null} is allowed
	 ...
	 *
	 * @param type the type that controls actual types for parsing
	 * @return a decoder
	 * @throws Exception
	 */
	 ...
	 *
	 * @param o The object to check for no cycles
