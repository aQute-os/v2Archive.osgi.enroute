...
@Requirement(namespace = ImplementationNamespace.IMPLEMENTATION_NAMESPACE, filter = "(&("
	+ ImplementationNamespace.IMPLEMENTATION_NAMESPACE + "=" + SchedulerConstants.SCHEDULER_SPECIFICATION_NAME
	+ ")${frange;${version;==;" + SchedulerConstants.SCHEDULER_SPECIFICATION_VERSION + "}})")
