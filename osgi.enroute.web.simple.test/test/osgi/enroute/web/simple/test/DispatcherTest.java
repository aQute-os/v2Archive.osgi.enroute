...
public class DispatcherTest extends TestCase {
	...
	public void testSkippingServlets() throws Exception {
		ServiceRegistration<ConditionalServlet> r10 = lp.getBundleContext()
			.registerService(ConditionalServlet.class, new TestSkipServlet("10"), MAP.$(Constants.SERVICE_RANKING, 10)
				.asHashtable());
		ServiceRegistration<ConditionalServlet> r20 = lp.getBundleContext()
			.registerService(ConditionalServlet.class, new TestSkipServlet("20"), MAP.$(Constants.SERVICE_RANKING, 20)
				.asHashtable());
		ServiceRegistration<ConditionalServlet> r30 = lp.getBundleContext()
			.registerService(ConditionalServlet.class, new TestSkipServlet("30"), MAP.$(Constants.SERVICE_RANKING, 30)
				.asHashtable());
		ServiceRegistration<ConditionalServlet> r40 = lp.getBundleContext()
			.registerService(ConditionalServlet.class, new TestSkipServlet("40"), MAP.$(Constants.SERVICE_RANKING, 40)
				.asHashtable());
		ServiceRegistration<ConditionalServlet> r50 = lp.getBundleContext()
			.registerService(ConditionalServlet.class, new TestServlet("50"), MAP.$(Constants.SERVICE_RANKING, 50)
				.asHashtable());
	...
	public void testRankingServlets() throws Exception {
		ServiceRegistration<ConditionalServlet> r100 = lp.getBundleContext()
			.registerService(ConditionalServlet.class, new TestServlet("100"), MAP.$(Constants.SERVICE_RANKING, 100)
				.asHashtable());
		ServiceRegistration<ConditionalServlet> r50 = lp.getBundleContext()
			.registerService(ConditionalServlet.class, new TestServlet("50"), MAP.$(Constants.SERVICE_RANKING, 50)
				.asHashtable());
	...
	public void testBadServlet() throws Exception {
		ServiceRegistration<ConditionalServlet> blacklist = lp.getBundleContext()
			.registerService(ConditionalServlet.class, new BadServlet(), MAP.$(Constants.SERVICE_RANKING, 100)
				.asHashtable());
